    ...
    <section id="education" className="bg-secondary/40 py-24 scroll-mt-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="relative ml-6 pl-6">
          {/* Vertical line */}
          <div className="absolute left-3 top-0 bottom-0 w-1 bg-primary/30" aria-hidden />

          {EDUCATION_TIMELINE.map((entry, index) => (
            <div key={entry.degree} className="relative mb-12 last:mb-0">
              {/* Dot */}
              <div className="absolute -left-3 top-0 flex h-6 w-6 -translate-x-1/2 items-center justify-center">
              ...
              {/* Card */}
              <div className="ml-8 rounded-2xl bg-background p-6 shadow-lg ring-1 ring-primary/10">
