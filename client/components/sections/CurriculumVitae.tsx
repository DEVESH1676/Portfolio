...
import { DOWNLOAD_CV_URL, RESEARCH_SUMMARY_URL } from "@/data/portfolio";

export const CurriculumVitaeSection = () => {
  return (
    <section id="cv" className="bg-secondary/40 py-24 scroll-mt-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="rounded-3xl border border-primary/20 bg-background/80 px-8 py-12 shadow-xl backdrop-blur-sm">
